...
We had to search manually to each object/appartment available online and then enter the values manually to the data tables. This tiring task made us to think of better/smarter alternatves by which we could extract data from the available online platforms and we also wanted to try it out in R.
